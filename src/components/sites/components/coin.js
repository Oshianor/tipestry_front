...
class Coin extends React.Component {
  ...
  render() {
    const { classes, topicId, topicUserId, site, data } = this.props;
    ...
    return (
      <div className={classes.iconspacing} >
        ...
        <CoinGift 
          ...
          image={img}
          type={type}
          siteId={typeof data.site.site !== 'undefined' && data.site.site.id}
          currentCoin={currentCoin}
          siteUserId={typeof data.site.site.claim !== 'undefined' && data.site.site.claim.userId}
