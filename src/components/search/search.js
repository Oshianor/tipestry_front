...
class UploadSite extends React.Component {
  ...
  handleSearch = async e => {
    const { searchBy, getTopics } = this.props;
    ...
    if ( value !== "") {
      ...
      try {
        ...
        // getTopics([]);
        getTopics({ topic: result.data, total: result.data.length });
...
export default connect(null, mapDispatchToProps)(withStyles(styles)(UploadSite));
