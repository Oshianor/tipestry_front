  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Typography
          variant="button"
          style={{ fontSize: 25, borderBottom: "1px solid darkgray" }}
        >
          {Lang.b3}
        </Typography>
        {token && (
          <div>
            ...
            <Typography style={{ marginTop: 15 }}>
              {Lang.z2}&nbsp;
              <strong>
                {typeof data.user.stage !== "undefined" ? data.user.stage : 1}
              </strong>
            </Typography>
            <Progress
              percent={
            ...
            <Typography
              variant="caption"
              style={{ margin: "10% 2% 0%", color: "gray" }}
            >
              <strong>Warning: </strong>
              Using multiple accounts to give yourself upvotes or tips can
              result in a ban and the loss of all coins in the account.
            </Typography>
          </div>
        )}
      </div>
