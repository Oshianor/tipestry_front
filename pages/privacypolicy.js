    ...
    return (
			<div>
				...
				<div style={{ textAlign: 'center', margin: "80px 10%" }} >
					<Typography variant="h4" >TERMS OF SERVICE AGREEMENT</Typography>
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								...
								Any and all visitors to our site, despite whether they are registered or not, shall be deemed as "users" of the herein contained Services provided
								for the purpose of this TOS.Once an individual register 's for our Services, through the process of creating an account, the user shall then be considered a "member."
								...
								for any such updates, modifications, revisions, suspensions or discontinuance of any of our Services and / or products.Your continued use of the Services provided, after such posting of any updates, changes, and / or modifications shall constitute your acceptance of such updates, changes and / or modifications, and as such, frequent review of this Agreement and any and all applicable terms and policies should be made by you to ensure you are aware of all terms and policies currently in effect.Should you not agree to the updated, revised or modified terms, you must stop using the provided Services forthwith.



								Furthermore, the user and / or member understands, acknowledges and agrees that the Services offered shall be provided "AS IS"
								and as such Tipestry Inc.shall not assume any responsibility or obligation
								for the timeliness, missed delivery, deletion and / or any failure to store user content, communication or personalization settings.
							</Typography>
						</ExpansionPanelDetails>
					</ExpansionPanel>
					<ExpansionPanel
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								...
								<Typography variant="button" >Furthermore, the registering party hereby acknowledges, understands and agrees to:</Typography>
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								...
								<Typography variant="button" >Furthermore, you herein agree not to make use of Tipestry Inc.'s Services for the purpose of:</Typography>
								<ul style={{ textAlign: 'left' }}>
									<li>Uploading, posting, emailing, transmitting, or otherwise making available any content that shall be deemed unlawful, tortious, defamatory, libelous, or invasive of another's privacy;</li>
									<li>Causing harm to minors in any manner whatsoever;</li>
									<li>Impersonating any individual or entity, including, but not limited to, any Tipestry officials, forum leaders, guides or hosts or falsely stating or otherwise misrepresenting any affiliation with an individual or entity;</li>
									...
									<li>Interfering with or disrupting any Tipestry Inc. Services, servers and/or networks that may be connected or related to our website, including, but not limited to, the use of any device software and/or routine to bypass the robot exclusion headers;</li>
								...
								<Typography variant="button" >Tipestry Inc. herein reserves the right to access, preserve and/or disclose member account information and/or content if it is requested to do so by law or in good faith belief that any such action is deemed reasonably necessary for:</Typography>
								<ul style={{ textAlign: 'left' }}>
					...
					>
						<ExpansionPanelSummary>
							<Typography>CAUTIONS FOR GLOBAL USE AND EXPORT AND IMPORT COMPLIANCE</Typography>
						</ExpansionPanelSummary>
						<ExpansionPanelDetails>
							<Typography>
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								...
								<ul style={{ textAlign: 'left' }}>
									<li>The content submitted or made available for inclusion on the publicly accessible areas of Tipestry Inc.'s sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly display said Content on our network Services is for the sole purpose of providing and promoting the specific area to which this content was placed and/or made available for viewing. This license shall be available so long as you are a member of Tipestry Inc.'s sites, and shall terminate at such time when you elect to discontinue your membership.</li>
									...
									<li>For any other content submitted or made available for inclusion on the publicly accessible areas of Tipestry Inc.'s sites, the continuous, binding and completely sub-licensable license which is meant to permit to use, distribute, reproduce, modify, adapt, publish, translate, publicly perform and/or publicly display said content, whether in whole or in part, and the incorporation of any such Content into other works in any arrangement or medium current used or later developed.</li>
								</ul>
						...
						<ExpansionPanelDetails>
							<Typography>
								...
								<ul style={{ textAlign: 'left' }}>
									...
									<li>Tipestry shall not be liable or under any obligation to ensure or maintain confidentiality, expressed or implied, related to any Contributions;</li>
									<li>Tipestry shall be entitled to make use of and/or disclose any such Contributions in any such manner as they may see fit;</li>
									<li>The contributor's Contributions shall automatically become the sole property of Tipestry; and</li>
									<li> Tipestry is under no obligation to either compensate or provide any form of reimbursement in any manner or nature.</li>
								</ul>
							</Typography>
						</ExpansionPanelDetails>
					</ExpansionPanel>
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								As a member of www.tipestry.com, you may cancel or terminate your account, associated email address and/or access to our Services by submitting a cancellation or termination request to feedback@tipestry.com.
								<br />
								...
								<ul style={{ textAlign: 'left' }} >
									...
									<li>the nonpayment of any associated fees that may be owed by you in connection with your www.tipestry.com account Services.</li>
								</ul>
								<br />
								...
								<ul>
									<li>the removal of any access to all or part of the Services offered within www.tipestry.com;</li>
					...
					>
						...
						<ExpansionPanelDetails>
							<Typography>
								BE IT KNOWN, that Tipestry Inc.complies with all applicable Federal Communications Commission rules and regulations regarding the closed captioning of video content.For more information, please visit our website at www.tipestry.com.
							</Typography>
						</ExpansionPanelDetails>
					</ExpansionPanel>
					<ExpansionPanel
